...
Большинство задач в домашнем задании по R предполагают автоматическое тестирование кода. 
Если какие-то тесты не пройдены, выводится ошибка вида `[something] не TRUE`. В строке с `print()` перед каждым тестом указано 
